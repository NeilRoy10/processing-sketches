...
void setup() {
  ...
  rainbow = loadImage("rainbow_PNG5570.png");  // 2. Change this to match your file name. 
  size(1500, 1000);
 ...
 background(rainbow);
  ...
  unicorn = loadImage("Unicorn-PNG-Picture.png"); // 5. Change this to match your file name.
}
